...
class ESHttpClient:
    """
    HTTP-based Elasticsearch client using requests library.
    Works with both ES 6.x and 8.x clusters.
    """
    ...
    def get_version(self) -> str:
        """Return the ES cluster version string."""
        info = self.info()
...
ElasticsearchClient = ESHttpClient
